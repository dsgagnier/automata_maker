...
This module contains one function for presenting a text menu to a user and
getting a keyboard-entered choice from that menu:
...
if __name__ == '__main__':
    # Test code
    # The menu choices array may be arbitrarily long
